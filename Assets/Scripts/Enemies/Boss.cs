...
public class Boss : MonoBehaviour
{
    ...
    [SerializeField] float attackRate = 0.15f;
    ...
    [SerializeField] float arrowAmount = 6;
    [SerializeField] float arrowFirerate = 0.5f;
    ...
    IEnumerator WaitForAttackAnimation()
    {
        ...
        {
            StartCoroutine(WaitToFireArrow(shootPoint));
        }
    ...
    IEnumerator WaitToFireArrow(Transform shootPoint)
    {
